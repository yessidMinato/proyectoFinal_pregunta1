...
<div class="container">
    ...
    <div class="row g-3 needs-validation">
        ...
        <div class="col-md-5">
            <label for="validationCustom06" class="form-labe    l">Codigo de personal:</label>
        ...
        <div class="col-md-3">
        <img src="<?php echo $firma?>" alt="ci2" class="card-img-top" style="width: 200px;">
        </div>
        <div class="mb-3">
        <a href="./fpdf/certificado.php" target="_blank" class="btn btn-primary" style="padding: 10px 50px; background-color: green;">Generar certificado virtual</a>
        </div>
